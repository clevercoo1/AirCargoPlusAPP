...
public abstract class AbsCommonAdapter<T> extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final njkgkj.com.aircargoplusapp.tools.freegridview.AbsViewHolder viewHolder = getViewHolder(position, convertView, parent);
        convert(viewHolder, getItem(position), position);
        return viewHolder.getConvertView();

    }

    public abstract void convert(njkgkj.com.aircargoplusapp.tools.freegridview.AbsViewHolder helper, T item, int pos);

    private njkgkj.com.aircargoplusapp.tools.freegridview.AbsViewHolder getViewHolder(int position, View convertView, ViewGroup parent) {
        return njkgkj.com.aircargoplusapp.tools.freegridview.AbsViewHolder.get(
