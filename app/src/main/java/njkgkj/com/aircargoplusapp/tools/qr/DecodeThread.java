...
package njkgkj.com.aircargoplusapp.tools.qr;
...
public class DecodeThread extends Thread {
	...
	public DecodeThread(CaptureActivity activity, int decodeMode) {
		...
		switch (decodeMode) {
		case BARCODE_MODE:
			decodeFormats.addAll(njkgkj.com.aircargoplusapp.tools.qr.DecodeFormatManager.getBarCodeFormats());
			break;

		case QRCODE_MODE:
			decodeFormats.addAll(njkgkj.com.aircargoplusapp.tools.qr.DecodeFormatManager.getQrCodeFormats());
			break;
