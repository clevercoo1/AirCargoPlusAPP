package njkgkj.com.aircargoplusapp.tools.freegridview;
/*
...
public class AbPullToRefreshView extends LinearLayout {
     ...
     * header view.
     */
    private njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewHeader mHeaderView;

    /**
     * footer view.
     */
    private njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewFooter mFooterView;
    ...
    private void addHeaderView() {
        mHeaderView = new njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewHeader(mContext);
    ...
    private void addFooterView() {
        ...
        mFooterView = new njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewFooter(mContext);
    ...
    private void headerPrepareToRefresh(int deltaY) {
        ...
        if (newTopMargin >= 0 && mHeaderView.getState() != njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewHeader.STATE_REFRESHING) {
            //提示松开刷新
            mHeaderView.setState(njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewHeader.STATE_READY);

        } else if (newTopMargin < 0 && newTopMargin > -mHeaderViewHeight) {
            //提示下拉刷新
            mHeaderView.setState(njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewHeader.STATE_NORMAL);
        }
    }
    ...
    private void footerPrepareToRefresh(int deltaY) {
        ...
        if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight) && mFooterView.getState() != njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewFooter.STATE_LOADING) {
            mFooterView.setState(njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewFooter.STATE_READY);
        } else if (Math.abs(newTopMargin) < (mHeaderViewHeight + mFooterViewHeight)) {
            mFooterView.setState(njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewFooter.STATE_LOADING);
        }
    }
    ...
    public void headerRefreshing() {
        ...
        mHeaderView.setState(njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewHeader.STATE_REFRESHING);
    ...
    public void onHeaderRefreshFinish() {
        if (mHeaderView.getState() == njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewHeader.STATE_REFRESHING) {
            ...
            if (mAdapterView != null) {
                ...
                if (mCount > 0) {
                    ...
                    mFooterView.setState(njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewFooter.STATE_EMPTY);
                }
            } else {
                mFooterView.setState(njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewFooter.STATE_READY);
            }
    ...
    public void onFooterLoadFinish() {
        ...
        if (mAdapterView != null) {
            ...
            if (countNew > mCount) {
                ...
                mFooterView.setState(njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewFooter.STATE_NO);
            }
        } else {
            mFooterView.setState(njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewFooter.STATE_READY);
        }
     ...
     */
    public njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewHeader getHeaderView() {
        return mHeaderView;
    }
     ...
     */
    public njkgkj.com.aircargoplusapp.tools.freegridview.AbListViewFooter getFooterView() {
        return mFooterView;
    }
